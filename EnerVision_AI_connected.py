...
# 🟢 Surplus: Net Energy > +1.5 kW
# 🟡 Balance: 0 kW <= Net Energy <= +1.5 kW
# 🔴 Shortage: Net Energy < 0 kW
def classify_status(net_energy):
    """Use the project-defined operational thresholds everywhere."""
...
c1.metric("🌤️ Weather", weather)
c2.metric(
    "🌡️ Temperature",
    f"{float(temperature):.2f} °F" if pd.notna(temperature) else "N/A",
)
c3.metric("💧 Humidity", f"{humidity:.1f}%")
c4.metric("☀️ Solar Generation", f"{solar * 1000:.2f} W")


st.header("🔋 Energy Status")

# =========================================================
# STATUS SECTION - CURRENT STATUS + SELECTED DAY COUNT
# =========================================================
...
# =========================================================
# STATUS COUNT - SELECTED DAY
# =========================================================

st.subheader("Count of Energy Status")
...
st.header("☀️ Solar Generation vs Energy Consumption")
...
st.header("🏠 Energy Consumption by Area")
